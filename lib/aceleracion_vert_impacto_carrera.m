function [rms_acc_impacto_segmentos, rms_acc_impacto_moda] = aceleracion_vert_impacto_carrera(ic, fc, acc_vert, gyr_ml, plot_graph)
%ACELERACION_VERT_IMPACTO_CARRERA Calcula la RMS de la aceleración de impacto durante la carrera.
%
%   [rms_acc_impacto_segmentos, rms_acc_impacto_moda] = aceleracion_vert_impacto_carrera(ic, fc, acc_vert, gyr_ml)
%
...
%       [rms_vals, moda_val] = aceleracion_vert_impacto_carrera(ic, fc, acc_vert, gyr_ml);
%
%   See also: aceleracion_vert_frenado_carrera, rms, mode
%
